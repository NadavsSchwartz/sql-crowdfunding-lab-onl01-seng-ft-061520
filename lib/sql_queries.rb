...
def selects_the_titles_and_amount_over_goal_of_all_projects_that_have_met_their_funding_goal
  "SELECT projects.title, (SUM(pledges.amount) - projects.funding_goal) FROM projects JOIN projects ON projects_id = pledges.project_id WHERE pledges.amount > projects.funding_goal;"
end
